...
{
    public static class DadosBaseTestes
    {
        public static Plano GeradorPlanoCompleto()
        {
        ...
        public static Plano GeradorPlanoSimples()
        {
            Plano plano = new Plano();
        ...
        public static Ciclo GerarCicloCompleto()
        {
        ...
        public static Ciclo GerarCicloSimples()
        {
            Ciclo ciclo = new Ciclo()
            {
                JurosMensal = 0.005,
        ...
        public static Ciclo GerarCicloSimples2()
        {
            Ciclo ciclo = new Ciclo()
            {
                JurosMensal = 0.003,
